...
import { Contact, Mail, Pen, User, FileText, Upload, CheckCircle2, XCircle, Briefcase, GraduationCap, Award, Star, Image, Phone, Trash2, MapPin, DollarSign, Link2, Heart, Languages } from "lucide-react";
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {user?.profile?.languages?.map((lang, index) => (
                                        <div key={index} className="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300">
                                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{lang.language}</h3>
                                            <p className="text-gray-600 dark:text-gray-300">Proficiency: {lang.proficiency}</p>
                                        </div>
                                    ))}
                                </div>
                            </motion.div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {user?.profile?.certifications?.map((cert, index) => (
                                        <div key={index} className="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300">
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                {cert.date} - {cert.expiryDate || 'No expiry'}
                                            </p>
                                            {cert.credentialId && (
